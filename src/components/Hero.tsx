  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 max-w-4xl mx-auto w-full text-center">
        ...
        {/* Subtitle */}
        <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-2 leading-relaxed animate-fade-in delay-200">
          코딩 경험 제로? 전혀 문제없어요.
        </p>
        <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed animate-fade-in delay-200">
        ...
        {/* Hero image — 서브타이틀 바로 아래 */}
        <div className="w-full animate-fade-in delay-300 mb-8">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-neon-lime/10 border border-neon-lime/10">
            <Image
        ...
        {/* Date & location */}
        <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full border border-gray-700/50 bg-gray-800/30 backdrop-blur-sm mb-10 animate-fade-in delay-300">
          <div className="flex items-center gap-1.5 text-sm text-gray-300">
        ...
        <div className="flex flex-row gap-3 w-full max-w-sm mx-auto sm:max-w-none sm:w-auto sm:justify-center animate-fade-in delay-400">
          <a
            href="#preparation"
